      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex-1">
            <h1 className="text-xl sm:text-2xl font-bold text-pink-800">👥 Gestión de Empleados</h1>
            <p className="text-gray-600 mt-1 text-sm sm:text-base">Administra y gestiona el equipo de tu clínica</p>
          </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="divide-y divide-gray-200" style={{ backgroundColor: 'rgb(255 255 255 / 0%)' }}>
                {filteredEmployees.map((employee) => (
                  <tr key={employee.id} className="hover:transition-colors duration-150" style={{ backgroundColor: 'rgb(255 255 255 / 0%)' }}>
                    {/* Empleado */}
