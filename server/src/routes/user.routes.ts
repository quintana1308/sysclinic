...
import { getUsers, getUserById, createUser, updateUser, deleteUser, getUserStats, getRoles, updateUserPassword } from '../controllers/user.controller';
...
router.put('/:id/password', authenticate, authorize('master'), updateUserPassword);
